...
function CartItem({ product, handleDelete, handleIncrement, handleDecrement }: CartItemProps) {
  return (
    <div>
          ...
          <div className="flex items-center justify-between md:order-3 md:justify-end">
            <div className="flex items-center">
              <button
                ...
                id="decrement-button"
                className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 green:border-gray-600 green:bg-gray-700 green:hover:bg-gray-600 green:focus:ring-gray-700"
              >
                <svg
                  className="h-2.5 w-2.5 text-gray-900 green:text-green"
                  aria-hidden="true"
              ...
              <input
                type="text"
                id="counter-input"
                className="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 green:text-green"
          ...
          <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                type="button"
                className="inline-flex items-center text-sm font-medium text-red-600 hover:underline green:text-red-500"
              >
                <svg
